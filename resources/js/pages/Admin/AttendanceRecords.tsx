...
export default function AttendanceRecords() {
    ...
    const inputStyle: React.CSSProperties = {
        height: 36, padding: '0 12px', fontSize: 13, fontFamily: 'inherit',
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div style={{ padding: '24px', fontFamily: 'ui-sans-serif, system-ui, sans-serif' }}>
                ...
                <div style={{ marginBottom: 20 }}>
                    ...
                    <p style={{ fontSize: 13, color: '#9CA3AF', margin: '3px 0 0' }}>All attendance data across every subject and session</p>
                </div>
                ...
                <div style={{ background: '#fff', border: '1px solid #F3F4F6', borderRadius: 14, padding: '16px 18px', marginBottom: 16, boxShadow: '0 1px 2px rgba(0,0,0,0.04)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
                        ...
                        {hasFilters && (
                            <button onClick={clearFilters} style={{ display: 'flex', alignItems: 'center', gap: 4, marginLeft: 'auto', fontSize: 11, color: '#6B7280', background: 'none', border: 'none', cursor: 'pointer', padding: '2px 6px' }}>
                                <X size={11} /> Clear all
                            </button>
                        )}
                    </div>
                ...
                <div style={{ background: '#fff', border: '1px solid #F3F4F6', borderRadius: 14, overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
                    ...
                    <div style={{ padding: '12px 20px', borderBottom: '1px solid #F3F4F6', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        {hasFilters && (
                            <span style={{ fontSize: 12, color: '#7C3AED', background: '#F5F3FF', padding: '3px 10px', borderRadius: 20 }}>Filtered</span>
                        )}
                    </div>
                                    ...
                                    return (
                                        <Link
                                            ...
                                            style={{
                                                ...
                                                borderRadius: 7, fontSize: 13, fontWeight: link.active ? 700 : 400, textDecoration: 'none',
                                                background: link.active ? '#111827' : '#F9FAFB',
                                                color: link.active ? '#fff' : link.url ? '#374151' : '#D1D5DB',
                                                border: '1px solid ' + (link.active ? '#111827' : '#F3F4F6'),
